...
const ICOToken = ({ setLoader }) => {
  ...
  const CALLING_FUNCTION_TOKEN_WITHDRAW = async () => {
    ...
    const receipt = await TOKEN_WIDTHRAW();
        ...
        <div className="col-12">
          <div className="profile">
            ...
            >
              ...
              <ButtonCmp name={"Widthdraw Token "} tab={"f11"} />
            </ul>
            {/* 1 */}
              ...
              <div className="tab-pane fade  " id="tab-f10" role="tabpanel">
                <div className="row">
                  ...
                  <InputField
                    ...
                    title={"Price"}
                    name={"price1"}
                    placeholder={`${tokenDetails?.tokenPrice || "0.00000000"} `}
            ...
            <div className="tab-content">
              <div className="tab-pane fade  " id="tab-f11" role="tabpanel">
                <div className="row">
                  <Title title={"widthdraw Token from ICO Contract"} />
